...
##    user_cmd_thr.start()
    ...
    enter_user_cmds()                        # FOR DEBUGGING.  SHOULD BE RUN AS A THREAD INSTEAD
    
    print('/n/nCOMMAND QUEUE HAS {} ITEMS.  ITEMS ARE:'.format(cmd_q.qsize()))
##    for i in range(cmd_q.qsize()):
##          c = cmd_q.get()
##          print("Item {}: {}".format(i,c))
    
    ##  *** COMMENTED OUT FOR DEBUGGGING ONLY
