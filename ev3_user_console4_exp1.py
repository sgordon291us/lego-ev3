...
#***  THIS NEXT PIECE OF CODE NEEDS TO FLUSH THE CHARACTER JUST TYPED FROM THE BUFFER.  I DONT KNOW HJOW TO DO THIS              
#             if spec_key:
#                 cmd = input()                  #Flush the input buffer and get ready for next command
