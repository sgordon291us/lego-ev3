...
RxToPeriod = 2      #Seconds.  This is the amount of time that can pass before doing a buffer reset
...
while 1:
        if EV3.inWaiting() >= 2: # check for ev3 message
            ...
            print("Time Since Last Rx: ", timeSinceLastRx.seconds)
            if timeSinceLastRx > RxToPeriod:
                EV3.flush
