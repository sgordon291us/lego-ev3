#! /usr/bin/env python
# import packages
#This version of the code takes turns with the EV3 sending messages back and forth.
#The EV3 starts by sending the first messsage, then waits for one from the RPI for a max
# wait time of n seconds.  The RPi starts by waiting for the same max wait time of n seconds
#then sends to the EV3
import serial
import time
import datetime
import struct
